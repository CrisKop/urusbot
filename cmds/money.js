...
exports.run = async(client, message, args, Discord) =>{
 ...
 return message.channel.send(new Discord.RichEmbed()
                        .setAuthor(message.author.tag, message.author.displayAvatarURL)
                             .addField('Cash:', `<:UrusCOIN:756959373309509783> ${usuariocash}`, true)
                             .addField('Bank:', `<:UrusCOIN:756959373309509783> ${usuariobank}`, true)
    ...
    if(usuario.user.bot) return message.channel.send('Only users, no bots :p');
